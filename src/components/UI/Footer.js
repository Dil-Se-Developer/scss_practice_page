...
const Footer = () => {
  return (
    <footer className='page_container footer_section'>
      <div className='footer_top_section'>
        <div className='footer_top_logo'>
          <img src={logo} alt='zomato_logo' />
        </div>
        <div className='footer_top_dropdown'>
          <div className='footer_top_country'>
            <span></span>
            <p>India</p>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width="15" height="15" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img">
          ...
          <div className='footer_top_langauge'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width="18" height="18" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img">
      ...
      <div className='footer_mid_section'>
        ...
        <div className='footer_mid_social_card'>
          <h4>Social Links</h4>
          <div className='footer_mid_social_icons'>
            <a
              href="https://www.linkedin.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
            <svg xmlns="http://www.w3.org/2000/svg" fill="#1C1C1C" width="22" height="22" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img">
