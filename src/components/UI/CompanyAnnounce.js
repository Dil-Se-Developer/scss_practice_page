...
import "./CompanyAnnounce.scss";

const CompanyAnnounce = () => {
  return (
  <div className="page_container company_announce_container">
    <h4>Zomato announces proposed acquisition of Blinkit</h4>
    <div className="company_announce_btn_section">
        <button>
          <svg
...
export default CompanyAnnounce;
